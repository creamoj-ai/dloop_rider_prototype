...
// Connect to WhatsApp database (aqpwfurradxbnqvycvkm)
// Use custom env var names (Supabase doesn't allow SUPABASE_ prefix in secrets)
const SUPABASE_URL = Deno.env.get("DB_URL") ?? Deno.env.get("SUPABASE_URL") ?? "https://aqpwfurradxbnqvycvkm.supabase.co";
